            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a href="gestion_clientslocal" class="active"><i class="fa fa-users nav_icon"></i>Gestion des clients</a>
                ...
                <div class="modal-body mx-1">
                    <form method="post" action="Resultatlocal">
                        <div class="form-group container-add modalitosmall">
                            ...
                            <input type="date" style="color: black;" id="date_debut" name="date_debut" min="<%= java.time.LocalDate.now()%>" onchange="document.getElementById('date_fin').min=this.value;" placeholder="yyyy-mm-dd">
							<br>
                            <label for="date_fin"><b>date de reserve</b></label>
                            <input type="date" style="color: black;" id="date_fin" name="date_fin" min="<%= java.time.LocalDate.now()%>" placeholder="yyyy-mm-dd">
                            <br>
                             <input type="hidden" name="cin_client" value="<c:out value="${value.cin}"/>" />  
                            
                            <input type="submit" style="color: black;" value="Rechercher">
                        </div>
                    </form>
                </div>
            </div>
                                            ...
                                            <div class="modal-body mx-1">
                                                <form class="form-validate" method="post"
                                                    ...
                                                    <div class="form-group container-add modalito">
                                                        ...
                                                        <input type="text" style="color: black;" placeholder="Entrer Un Nom" name="nom"
                                                           value="${value.nom}">

                                                        <label for="prenom"><b>Prenom</b></label>
                                                        <input type="text" style="color: black;" placeholder="Entrer un Prenom"
                                                            name="prenom" value="${value.prenom}">

                                                        <label for="phone"><b>Telephone</b></label>
                                                        <input type="tel" style="color: black;" placeholder="Entrer N° telephone"
                                                            name="phone" min="1" value="${value.phone}">

                                                        <label for="email"><b>Email</b></label>
                                                        <input type="text" style="color: black;" placeholder="Entrer EMAIL"
                                                            name="email" min="1" value="${value.email}">
                                                        <label for="mdp"><b>Mot de passe</b></label>
                                                        <input type="text" style="color: black;" placeholder="Entrer MOT DE PASSE"
                                                            name="mdp" min="1" value="${value.password}">
                                                            <label for="addresse"><b>Addresse</b></label>
                                                        <input type="text" style="color: black;" placeholder="Entrer  ADDRESSE"
