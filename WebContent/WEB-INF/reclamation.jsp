    ...
    <div id="page">
	  ...
	  <input style=" border:none;background-color:transparent;" type="submit" value="Deconnexion" />
        ...
        <div class="test">
                ...
                <textarea class="form-control z-depth-1" name="text" cols="300" rows="10" disabled>type de recelemation: ${r.type} ${r.text}</textarea>
                ...
                <button class="btn btn-info btn-block free" type="button">modifier</button>
            </form>
