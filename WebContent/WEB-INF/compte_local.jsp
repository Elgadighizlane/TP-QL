...
<body class="cbp-spmenu-push">
 ...
 <input type="hidden" name="deconnecterlocal" value="deconnecterlocal" />
	...
	<form method="post" action="comptelocal">
<ul class="form-style-1">

<li><label>CIN </label><input id="cin" type="text" value="${sessionScope.session_local.cin}"  name="cin"  placeholder="CIN" disabled="true" /> </li>

    <li><label>Nom complete </label><input value="${sessionScope.session_local.nom}"  type="text" id="nom" name="nom" class="field-divided" placeholder="First" disabled="true"/> <input type="text" name="prenom" id="prenom" value="${sessionScope.session_local.prenom}" class="field-divided" placeholder="Last" disabled="true" /></li>
    <li>
        <label>Nom et ville de l'Hotel </label>
        <input type="text" name="nom_hotel" id="nom_hotel" value="${sessionScope.session_local.nom_hotel}" class="field-divided" disabled="true" />
   
        <input type="text" name="ville" id="ville" value="${sessionScope.session_local.ville_hotel}" class="field-divided" disabled="true" />
    </li>
     <li>
        <label>numero téléphone </label>
        <input type="text" name="tele" id="tele" value="${sessionScope.session_local.telephone}" class="field-long" disabled="true" />
    </li>
     <li>
        <label>Email </label>
        <input type="email" id="email" name="email" value="${sessionScope.session_local.email}" class="field-long" disabled="true"/>
    </li>
     <li>
        <label>addresse </label>
        <input type="text" name="addresse" id="addresse" value="${sessionScope.session_local.addresse}" class="field-long" disabled="true" />
    </li>
     <li>
        <label>mot de passe </label>
        <input type="password" name="pass" id="pass" value="${sessionScope.session_local.mot_passe}" class="field-long" disabled="true" />
    </li>
    <li>
        <label>mot de passe </label>
        <input type="password" name="pass2" id="pass2" value="${sessionScope.session_local.mot_passe}" class="field-long" disabled="true" />
    </li>
