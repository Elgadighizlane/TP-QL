...
<script> window.alert("${sessionScope.messagelo}")</script> 
                ...
                <c:forEach items="${clients}" var="value" varStatus="i">
                    <tr>
                        ...
                        <td><a href="gestion_reservations?cin=${value.cin}&type=true">Afficher Reservations</a></br>
                            <div class="modal fade${i.count}" id="modaladdform${i.count}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
    ...
    <div class="text-center">
        <a href="" class="btn btn-default btn-rounded mb-4" data-toggle="modal" data-target="#modaladdform${i.count}">Ajouter une
            Reservation</a>
    </div>
                        </td>
                        <td>
